# Receives x (float) as command-line input; and writes as standard output the square root of x, reporting an error 
# if x is not specified, is not a float, or is negative.
