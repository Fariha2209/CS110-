# Receives n (int) as command-line input; and draws using standard draw a plot of the percolation probability 
# (experimental observation) against the vacancy probability (control variable).
...
# Generates a random n-by-n percolation system with vacancy probability p and determines if the system percolates. 
# Repeats trials times. Returns an estimate of the empirical percolation probability of such systems.
