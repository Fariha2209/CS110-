# Receives n (int), steps (int), and stepSize (float) as command-line inputs; creates n Turtle objects; and has the 
# turtles take steps random steps, each of size stepSize.

from turtlex import Turtle
import stdarray
import stddraw
import stdrandom
import sys
