...
class Sketch:
    # Constructs a new sketch which is a profile of text, as a d-dimensional unit vector. Component i of the vector 
    # indicates how many k-grams in the text hash to i.
    ...
    # Returns the similarity measure between this and the other sketch, as a number between 0 and 1. The value 0 
    # indicates that the sketches are dissimilar, and 1 indicates that they are similar.
