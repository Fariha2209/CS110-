# Receives xc (float), yc (float), and size (float) as command-line inputs; and draws using standard draw the 
# size-by-size region of the Mandelbrot set, centered at (xc, yc).
