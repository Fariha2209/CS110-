...
# Given the full sites of a percolation system, returns True if the system percolates, and False otherwise.
...
# Given the open and full sites of a percolation system, updates the full sites by marking every site of that system 
