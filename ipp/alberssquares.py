# Receives r1 (int), g1 (int), b1 (int), r2 (int), g2 (int), and b2 (int) as command-line inputs; and draws using 
# standard draw Albers' squares with colors (r1, g1, b1) and (r2, g2, b2).
